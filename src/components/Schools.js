...
<p>Here is application process:</p>
<ul>
<li>Beginning of program application- September</li>
<li>Steps are- program selection, submission of translation requests, document transfers from Physiciansapply.ca, Letter of Recommendation sent by mail, Document assignments, File review, National Interview, ranking, rank order list</li>
<li>Matching -February</li>
</ul>
For more information go to www.carms.ca
</div>
        );
    }
}
